    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
      ...
      {showScene && (
        <div className="fixed inset-0 z-50 bg-black flex items-center justify-center overflow-hidden">
          <div className="relative w-full h-full max-w-[1400px] max-h-[900px] bg-white rounded-lg shadow-2xl overflow-hidden border-4 border-gray-800">
            {/* 退出按钮 */}
            <button 
              onClick={() => setShowScene(false)}
              className="absolute top-6 right-6 z-50 bg-red-500 text-white px-6 py-3 rounded-full font-bold text-lg shadow-xl hover:bg-red-600 transition-all transform hover:scale-105 border-2 border-white"
            >
              退出场景
            </button>
